...
var _initRellaxParalax = __webpack_require__(2);

var _initRellaxParalax2 = _interopRequireDefault(_initRellaxParalax);
...
window.DOM = {
  ...
  navLang: (0, _jquery2.default)('.navigation-lang'),
  navLogo: (0, _jquery2.default)('.navigation-logo'),
  navSearch: (0, _jquery2.default)('.navigation-search'),
  navBurger: (0, _jquery2.default)('.navigation-burger'),
  navBack: (0, _jquery2.default)('.navigation-back'),
  headerLinks: (0, _jquery2.default)('.header-links'),
  docLang: (0, _jquery2.default)('html').attr('lang'),
  menu: (0, _jquery2.default)('.js-popup-container'),
  menuClose: (0, _jquery2.default)('.js-popup-container').find('.closePopup'),
  pageLoader: (0, _jquery2.default)('.page-loader'),
  pageLoaderW: (0, _jquery2.default)('.page-elem.white'),
  pageLoaderB: (0, _jquery2.default)('.page-elem.blend'),
  ...
  hideScroll: function hideScroll() {
    ...
    (0, _jquery2.default)('.js-stick').trigger('sticky_kit:recalc');
  },
  ...
  addListenerMulti: function addListenerMulti(el, s, fn) {
    s.split(' ').forEach(function (e) {
      return el.addEventListener(e, fn, window.DOM.passiveSupported ? { passive: true } : false);
    });
  }
};
...
exports.default = initRellaxParalax;

var _rellax = __webpack_require__(7);

var _rellax2 = _interopRequireDefault(_rellax);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function initRellaxParalax() {

  setTimeout(function () {
    var rellaxParalax = $('.rellax');
    if (rellaxParalax.length) {
      window.DOM.rellax = new _rellax2.default('.rellax', {
        center: true
      });
    }
  }, 0);
...
var _barba = __webpack_require__(8);

var _barba2 = _interopRequireDefault(_barba);

var _inputFocus = __webpack_require__(9);

var _inputFocus2 = _interopRequireDefault(_inputFocus);

var _formValidator = __webpack_require__(13);
...
var _initPopUp = __webpack_require__(15);

var _initPopUp2 = _interopRequireDefault(_initPopUp);

var _stickInit = __webpack_require__(16);

var _stickInit2 = _interopRequireDefault(_stickInit);

var _youtubeVideo = __webpack_require__(18);

var _youtubeVideo2 = _interopRequireDefault(_youtubeVideo);

var _initGallery = __webpack_require__(19);

var _initGallery2 = _interopRequireDefault(_initGallery);

var _initModels = __webpack_require__(20);

var _initModels2 = _interopRequireDefault(_initModels);

var _initSliders = __webpack_require__(21);
...
var _scrollAnimations = __webpack_require__(22);

var _scrollAnimations2 = _interopRequireDefault(_scrollAnimations);

var _initInnerSlider = __webpack_require__(24);

var _initInnerSlider2 = _interopRequireDefault(_initInnerSlider);

var _aboutMenu = __webpack_require__(27);
...
var cbk = function cbk(e) {
  if (e.currentTarget.href === window.location.href) {
    e.preventDefault();
    e.stopPropagation();
    (0, _jquery2.default)('.modal-layout').removeClass('active');
    setTimeout(function () {
...
var BarbaWitget = {
  init: function init() {
    ...
    */
    ...
    _barba2.default.Dispatcher.on('linkClicked', function (elem) {
      // console.log(elem);
      var _t = (0, _jquery2.default)(elem);
    ...
    _barba2.default.Dispatcher.on('transitionCompleted', function (currentStatus, oldStatus, container) {
      setTimeout(function () {
    ...
    var FadeTransition = _barba2.default.BaseTransition.extend({
      ...
      fadeIn: function fadeIn() {
        var _this = this;
        var newCont = (0, _jquery2.default)(this.newContainer);
        var oldCont = (0, _jquery2.default)(this.oldContainer);
        var blockContent = newCont.find('.block-load');
        var blockBg = newCont.find('.block__bg');
        window.scroll(0, 0);
        window.DOM.hideScroll();
        var tlIn = new _gsap.TimelineMax();
        tlIn.set(oldCont, {
          display: 'none'
        }).set(newCont, {
          autoAlpha: 1,
          onComplete: function onComplete() {
            ...
            tlIn.set(blockContent, {
              ...
              clearProps: 'all',
              onComplete: function onComplete() {
                tlIn.set(window.DOM.pageLoaderB, {
                  clearProps: 'all'
...
var index = _barba2.default.BaseView.extend({
  namespace: 'index',
  onEnter: function onEnter() {
    window.DOM.navLang.addClass('visible-lang');
  },
  onEnterCompleted: function onEnterCompleted() {
    (0, _homeVideo2.default)();
  },
  onLeave: function onLeave() {
    window.DOM.navLang.removeClass('visible-lang');
  },
  onLeaveComplete: function onLeaveComplete() {}
});
...
var about = _barba2.default.BaseView.extend({
  ...
  onEnterCompleted: function onEnterCompleted() {
    ...
    (0, _initSliders2.default)();
    (0, _initRellaxParalax2.default)();
    (0, _scrollAnimations2.default)();
    (0, _aboutMenu2.default)();
  },
  onLeave: function onLeave() {
...
var gallery = _barba2.default.BaseView.extend({
  namespace: 'gallery',
  onEnter: function onEnter() {},
  onEnterCompleted: function onEnterCompleted() {
    window.DOM.headerLinks.addClass('show-header-links');
...
var galleryNews = _barba2.default.BaseView.extend({
  namespace: 'gallery-news',
  onEnter: function onEnter() {},
  onEnterCompleted: function onEnterCompleted() {
    window.DOM.headerLinks.addClass('show-header-links');
    (0, _jquery2.default)('.gallery-news-footer').addClass('visible');

    (0, _youtubeVideo2.default)();
    (0, _stickInit2.default)();
    (0, _initRellaxParalax2.default)();
    (0, _scrollAnimations2.default)();
  },
  onLeave: function onLeave() {
    window.DOM.headerLinks.removeClass('show-header-links');
    (0, _jquery2.default)('.gallery-news-footer').removeClass('visible');
  },
  onLeaveComplete: function onLeaveComplete() {
    window.DOM.rellax.destroy();
  }
...
var models = _barba2.default.BaseView.extend({
  namespace: 'models',
  onEnter: function onEnter() {},
  onEnterCompleted: function onEnterCompleted() {
    window.DOM.headerLinks.addClass('show-header-links');
    window.DOM.navSearch.addClass('active');
    (0, _initModels2.default)();
...
var innerModel = _barba2.default.BaseView.extend({
  namespace: 'inner-model',
  onEnter: function onEnter() {
    window.DOM.navLogo.addClass('hide-nav-logo');
  },
  onEnterCompleted: function onEnterCompleted() {
    (0, _initInnerSlider2.default)();
    (0, _youtubeVideo2.default)();
    (0, _jquery2.default)('.inner-wrap').addClass('active');
  ...
  onLeave: function onLeave() {
    ...
    (0, _jquery2.default)('.inner-info').removeClass('active');
  },
  onLeaveComplete: function onLeaveComplete() {}
});

var error = _barba2.default.BaseView.extend({
  namespace: 'error',
  onEnter: function onEnter() {
    window.DOM.navLang.addClass('visible-lang');
  },
...
exports.default = setInputFocus;

var _jqueryFormValidatorMin = __webpack_require__(10);

var _jqueryFormValidatorMin2 = _interopRequireDefault(_jqueryFormValidatorMin);
...
function setInputFocus() {
  ...
  var select_item = $('.select-list__item');
...
function formValidator() {
  ...
  if (_form.length) {
    ...
    _form.each(function () {
      ...
      }, _defineProperty(_$$validate, 'inlineErrorMessageCallback', function inlineErrorMessageCallback($input, errorMessage) {
        if (errorMessage) {
      ...
      }), _defineProperty(_$$validate, 'onValidate', function onValidate() {
        // CheckForSelect(form_this);
      }), _defineProperty(_$$validate, 'onSuccess', function onSuccess() {
...
function showVideo() {
  ...
  var video_c = $('.video-container');

  if (video_c.length > 0) {

    var video = video_c.find('video'),
        src = video.data('src');

    if (!isMobile()) {
      var newSourse = videoSource.cloneNode();
...
function initPopUp() {
  ...
  _this.f.openPopup = function (_popup) {
    _this.conf.isAnimate = true;
    _popup.addClass(_this.conf.active_class).promise().done(function () {
      setTimeout(function () {
        window.DOM.hideScroll();
      }, 200);
      _this.conf.isAnimate = false;
...
exports.default = initGallery;

var _isotopePkgdMin = __webpack_require__(3);

var _isotopePkgdMin2 = _interopRequireDefault(_isotopePkgdMin);
...
function initGallery() {
  ...
  if (elem) {
    var iso = new _isotopePkgdMin2.default(elem, {
    ...
    var filtersElem = document.querySelector('.gallery-filter');
    ...
    ajaxPagination = function ajaxPagination(e) {
      e.preventDefault();
...
function initModels() {
  ...
  var elem = document.querySelector('.models-wrap');
  if (elem) {
    ...
    var $quicksearch = $('#searching').on('keyup', debounce(function (event) {
      ...
      if (iso.filteredItems.length < 1) {
        ...
        var searchFieldValue = $quicksearch.val();
    ...
    var clr_bttn = $('.clear-bttn').on('click', debounce(function () {
    ...
    var ajaxPagerLoadingClass = 'ajax-pager-loading',
        ...
        ajaxWrapAttribute = 'wrapper-class',
        busy = false,
        attachScrollPagination = function attachScrollPagination(wrapperClass) {
      var $wrapper = $('.' + wrapperClass),
          $window = $(window);
...
exports.default = initAboutSliders;
...
function initAboutSliders() {
  ...
  if (aboutSlider.length) {
    var about_slider = new _swiper2.default(aboutSlider, {
      direction: 'horizontal',
      loop: false,
      slidesPerView: 2,
      slidesPerGroup: 2,
...
var _inViewMin = __webpack_require__(23);
...
function scrollAnimations() {
  _inViewMin2.default.offset({
    top: 0,
    bottom: 0
  });
  _inViewMin2.default.threshold(0.1);

  var input_item = $('.input-item');
  if (input_item.length) {
    (0, _inViewMin2.default)('.input-item').on('enter', function (el) {
      if (!el.done) {
  ...
  var block_title = $('.form-block__title');
  if (block_title.length) {
    (0, _inViewMin2.default)('.form-block__title').on('enter', function (el) {
      if (!el.done) {
        el.classList.add('animate');
      }
    }).on('exit', function (el) {
  ...
  var link_footer = $('.link-footer-inner');
  if (link_footer.length) {
    (0, _inViewMin2.default)('.link-footer-inner').on('enter', function (el) {
      el.classList.add('animate');
    }).on('exit', function (el) {
...
exports.default = initInnerSlider;

var _swiper = __webpack_require__(4);

var _swiper2 = _interopRequireDefault(_swiper);

var _lightgalleryMin = __webpack_require__(25);

var _lightgalleryMin2 = _interopRequireDefault(_lightgalleryMin);
...
function initInnerSlider() {
  ...
  var in_slider = $('.inner-slider');
  if (in_slider.length) {

    /* synchrones */
    var sychronize = function sychronize() {
      var active = 0;
      var indicatorL = 0;
    ...
    var pagiTriggers = $('.swiper-navigation').find('.slide-target');
    var slides = $('.swiper-slide');
    var slidesLength = slides.length;
    var indicator = $('.slide-indicator');
    ...
    swiper.on('progress', (0, _debounce2.default)(function () {
      var active = $('.swiper-slide-active');
      var triggerIndex = active.index();
      if (triggerIndex + 3 > slidesLength) {
        var trigger = slides.eq(triggerIndex + 1).data('link');
        pagiTriggers.removeClass('active').filter('[data-slide="' + trigger + '"]').addClass('active');
        sychronize();
      } else {
        var _trigger = active.data('link');
        pagiTriggers.removeClass('active').filter('[data-slide="' + _trigger + '"]').addClass('active');
        sychronize();
      }
    }));
    ...
    pagiTriggers.each(function () {
      var _ = $(this);
      _.on('click', function () {
        var target = _.data('slide');
        var realInd = swiper.realIndex;
        var neededItems = slides.filter('[data-link="' + target + '"]');
        var neededItemsIndex = neededItems.first().index();
        setTimeout(function () {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! lightgallery - v1.6.6 - 2017-12-20
